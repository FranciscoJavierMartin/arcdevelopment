...
const CustomSoftwarePage: React.FC<ICustomSoftwarePageProps> = ({
  setCurrentTab,
  setSelectedIndex,
}) => {
    ...
    <Grid container direction='column'>
      ...
      >
        ...
        >
          ...
          <Grid item>
            <img src={lightbulb} alt='lightbulb' style={{ marginTop: '1em' }} />
          </Grid>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <Grid item>
            <img src={stopwatch} alt='stopwatch' style={{ marginTop: '1em' }} />
          </Grid>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <Grid item>
            <img src={cash} alt='cash' style={{ marginTop: '1em' }} />
          </Grid>
        </Grid>
      </Grid>
      <Grid
