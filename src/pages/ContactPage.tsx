...
const useStyles = makeStyles((theme) => ({
  ...
  message: {
    border: `2px solid ${(theme.palette.common as any).blue}`,
    borderRadius: 5,
    marginTop: '5em',
  },
  sendButton: {
...
const ContactPage: React.FC<IContactPageProps> = ({ setCurrentTab }) => {
          ...
          <Grid container direction='column'>
            <Grid item>
              ...
              <Typography
                align={matchesMD ? 'center' : undefined}
                variant='body1'
                style={{ color: (theme.palette.common as any).blue }}
              >
                We are waiting
              </Typography>
            </Grid>
